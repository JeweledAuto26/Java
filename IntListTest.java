...
public class IntListTest
{
	...
	public static void dispatch(int choice)
	{
		...
		case 8:
			...
			oldVal = scan.nextInt();
			System.out.println("Enter the new integer value: ");
			newVal = scan.nextInt();
	...
	public static void printMenu()
	{
		...
		System.out.println("6: Display a string with the print values of the list");
		System.out.println("7: Remove an integer from the back of the list");
		System.out.println("8: Replace a specific integer in the list with a new integer");
